...
export default function Aktuelles() {
    return (
        ...
        <p className="absatzAktuelles">In diesem Jahr, gingen die Bauarbeiten am Mutter-Kind-Zentrum, das 2021 begonnen
...
ist für Ende 2023 vorgesehen. Reiselustige sind eingeladen, der Eröffnung beizuwohnen! </p>
        <img className="imgAktuelles" src={gesundheitszentrum5} alt="Baustelle der Entbindungsstation" />
        </div>
        </div>
        ...
        <div className="spalte2">
        <p className="absatzAktuelles">Am 8. Oktober lud die Selbsthilfegruppe zu einem öffentlichen Kulturfest ein. Es fand, wie schon im
...
gefördert hat und Danke allen, die gekommen sind oder kommen wollten. Es bedeutet uns viel.</p>
        <img className="imgAktuelles" src={kulturtag} alt="Soninké Frauen in traditioneller Kleidung" /> 
        </div>    
        </div>
        </>
        );
